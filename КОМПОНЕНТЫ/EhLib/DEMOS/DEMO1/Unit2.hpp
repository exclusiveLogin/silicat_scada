...
__published:
	...
	void __fastcall DBGridEh1DblClick(System::TObject* Sender);
	
private:
	HIDESBASE MESSAGE void __fastcall OnActivate(Messages::TWMActivate &msg);
	
public:
	bool __fastcall Execute(Controls::TControl* HostControl, AnsiString &VendorNo, AnsiString &VendorName
		);
public:
