...
uses
  ...
  OpPpt2K, OpOfc2K, OpShared, ActiveX, db;
...
begin
  ...
  if TOpPowerPoint(FSlideComponent.RootComponent).Connected then
    case Value of
    {$IFDEF VERSION6}
      pptsMixed: FSlideComponent.AsSlide.SlideShowTransition.Speed:= int64(ppTransitionSpeedMixed);
    ...
    {$ELSE}
      pptsMixed: FSlideComponent.AsSlide.SlideShowTransition.Speed:= integer(ppTransitionSpeedMixed);
...
begin
  ...
  begin
    ...
    Intf:= TOpPowerPoint(RootComponent).FServer.Presentations.Open(Value,
