...
// (DO NOT EDIT: machine generated header) 'OpPower.pas' rev: 5.00
...
#include <OpPpt2k.hpp>	// Pascal unit
...
#pragma option push -b-
enum TOpPpEntryEffect { ppeeNone, ppeeCut, ppeeCutThroughBlack, ppeeRandom, ppeeBlindsHorizontal, ppeeBlindsVertical, 
	ppeeCheckerboardAcross, ppeeCheckerboardDown, ppeeCoverLeft, ppeeCoverUp, ppeeCoverRight, ppeeCoverDown, 
	ppeeCoverLeftUp, ppeeCoverRightUp, ppeeCoverLeftDown, ppeeCoverRightDown, ppeeDissolve, ppeeFade, ppeeUncoverLeft, 
	ppeeUncoverUp, ppeeUncoverRight, ppeeUncoverDown, ppeeUncoverLeftUp, ppeeUncoverRightUp, ppeeUncoverLeftDown, 
	ppeeUncoverRightDown, ppeeRandomBarsHorizontal, ppeeRandomBarsVertical, ppeeStripsUpLeft, ppeeStripsUpRight, 
	ppeeStripsDownLeft, ppeeStripsDownRight, ppeeStripsLeftUp, ppeeStripsRightUp, ppeeStripsLeftDown, ppeeStripsRightDown, 
	ppeeWipeLeft, ppeeWipeUp, ppeeWipeRight, ppeeWipeDown, ppeeBoxOut, ppeeBoxIn, ppeeSplitHorizontalOut, 
...
#pragma option push -b-
enum TOpPpSlideLayout { ppslTitle, ppslText, ppslTwoColumnText, ppslTable, ppslTextAndChart, ppslChartAndText, 
	ppslOrgchart, ppslChart, ppslTextAndClipart, ppslClipartAndText, ppslTitleOnly, ppslBlank, ppslTextAndObject, 
	ppslObjectAndText, ppslLargeObject, ppslObject, ppslTextAndMediaClip, ppslMediaClipAndText, ppslObjectOverText, 
	ppslTextOverObject, ppslTextAndTwoObjects, ppslTwoObjectsAndText, ppslTwoObjectsOverText, ppslFourObjects, 
	ppslVerticalText, ppslClipArtAndVerticalText, ppslVerticalTitleAndText, ppslVerticalTitleAndTextOverChart 
	};
#pragma option pop
...
protected:
	...
	Opppt2k::_di__Slide __fastcall GetAsSlide();
...
public:
	...
	__property Opppt2k::_di__Slide AsSlide = {read=GetAsSlide};
...
__published:
	...
	__property bool FollowMasterBackground = {read=GetFollowMasterBackground, write=SetFollowMasterBackground
		, nodefault};
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpSlides(Classes::TComponent* RootComponent
...
protected:
	...
	Opppt2k::_di__Presentation __fastcall GetAsPresentation();
	virtual Classes::TCollection* __fastcall GetSubCollection(int index);
	virtual int __fastcall GetSubCollectionCount(void);
...
public:
	...
	__property Opppt2k::_di__Presentation AsPresentation = {read=GetAsPresentation};
...
__published:
	...
	__property TOpPpDirection LayoutDirection = {read=GetLayoutDirection, write=SetLayoutDirection, stored=
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpPresentations(Classes::TComponent* RootComponent
		, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(RootComponent
		, Owner, ItemClass) { }
	#pragma option pop
...
class PASCALIMPLEMENTATION TOpPowerPoint : public Opppt2k::TOpPowerPointBase 
{
	typedef Opppt2k::TOpPowerPointBase inherited;
	
protected:
	bool FVisible;
	AnsiString FCaption;
	TOpPresentations* FPresentations;
	Opppt2k::_di__Application FServer;
	int FLeft;
	int FWidth;
	int FHeight;
	int FTop;
...
public:
	...
	__property Opppt2k::_di__Application Server = {read=FServer};
