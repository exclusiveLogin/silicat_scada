...
// (DO NOT EDIT: machine generated header) 'OpDbOlk.pas' rev: 5.00
...
typedef void __fastcall (__closure *TGetListSourceEvent)(System::TObject* Sender, /* out */ Opolk2k::_di__Items 
	&ContactList);
...
private:
	...
	int FRecordPos;
	void __fastcall DoPostItem(Opolk2k::_di__ContactItem Item, void * Buffer);
	Opolk2k::_di_MAPIFolder __fastcall FindFolderByName(const Opolk2k::_di__Folders Fldrs, const AnsiString 
		Name);
	Opolk2k::_di__Items __fastcall FindMatchingFolder(Opolk2k::_di__Folders Fldrs);
...
public:
	...
	/*         class method */ static void __fastcall CreateFieldDefsFromProps(TMetaClass* vmt, Db::TFieldDefs* 
		FieldDefs);
};
...
__published:
	...
	__property AnsiString MailingAddressCountry = {read=FMailingAddressCountry, write=FMailingAddressCountry
		, index=177};
	__property AnsiString MailingAddressPostalCode = {read=FMailingAddressPostalCode, write=FMailingAddressPostalCode
		, index=179};
	__property AnsiString MailingAddressPostOfficeBox = {read=FMailingAddressPostOfficeBox, write=FMailingAddressPostOfficeBox
		, index=181};
	__property AnsiString MailingAddressState = {read=FMailingAddressState, write=FMailingAddressState, 
		index=183};
	__property AnsiString MailingAddressStreet = {read=FMailingAddressStreet, write=FMailingAddressStreet
		, index=185};
	__property AnsiString MobileTelephoneNumber = {read=FMobileTelephoneNumber, write=FMobileTelephoneNumber
		, index=191};
	__property AnsiString PagerNumber = {read=FPagerNumber, write=FPagerNumber, index=221};
	__property AnsiString PrimaryTelephoneNumber = {read=FPrimaryTelephoneNumber, write=FPrimaryTelephoneNumber
		, index=225};
public:
	#pragma option push -w-inl
...
__published:
	...
	__property AnsiString AssistantTelephoneNumber = {read=FAssistantTelephoneNumber, write=FAssistantTelephoneNumber
		, index=55};
	__property AnsiString Business2TelephoneNumber = {read=FBusiness2TelephoneNumber, write=FBusiness2TelephoneNumber
		, index=59};
	__property AnsiString BusinessAddressCity = {read=FBusinessAddressCity, write=FBusinessAddressCity, 
		index=63};
	__property AnsiString BusinessAddressCountry = {read=FBusinessAddressCountry, write=FBusinessAddressCountry
		, index=65};
	__property AnsiString BusinessAddressPostalCode = {read=FBusinessAddressPostalCode, write=FBusinessAddressPostalCode
		, index=67};
	__property AnsiString BusinessAddressPostOfficeBox = {read=FBusinessAddressPostOfficeBox, write=FBusinessAddressPostOfficeBox
		, index=69};
	__property AnsiString BusinessAddressState = {read=FBusinessAddressState, write=FBusinessAddressState
		, index=71};
	__property AnsiString BusinessAddressStreet = {read=FBusinessAddressStreet, write=FBusinessAddressStreet
		, index=73};
	...
	__property AnsiString BusinessTelephoneNumber = {read=FBusinessTelephoneNumber, write=FBusinessTelephoneNumber
		, index=79};
	__property AnsiString CompanyMainTelephoneNumber = {read=FCompanyMainTelephoneNumber, write=FCompanyMainTelephoneNumber
		, index=90};
	...
	__property AnsiString OrganizationalIDNumber = {read=FOrganizationalIDNumber, write=FOrganizationalIDNumber
		, index=201};
...
__published:
	...
	__property AnsiString Home2TelephoneNumber = {read=FHome2TelephoneNumber, write=FHome2TelephoneNumber
		, index=133};
	...
	__property AnsiString HomeAddressPostalCode = {read=FHomeAddressPostalCode, write=FHomeAddressPostalCode
		, index=141};
	__property AnsiString HomeAddressPostOfficeBox = {read=FHomeAddressPostOfficeBox, write=FHomeAddressPostOfficeBox
		, index=143};
	...
	__property AnsiString HomeTelephoneNumber = {read=FHomeTelephoneNumber, write=FHomeTelephoneNumber, 
		index=151};
...
__published:
	__property AnsiString ComputerNetworkName = {read=FComputerNetworkName, write=FComputerNetworkName, 
		index=94};
	...
	__property AnsiString InternetFreeBusyAddress = {read=FInternetFreeBusyAddress, write=FInternetFreeBusyAddress
		, index=155};
	...
	__property AnsiString RadioTelephoneNumber = {read=FRadioTelephoneNumber, write=FRadioTelephoneNumber
		, index=229};
	__property AnsiString TelexNumber = {read=FTelexNumber, write=FTelexNumber, index=239};
	__property AnsiString TTYTDDTelephoneNumber = {read=FTTYTDDTelephoneNumber, write=FTTYTDDTelephoneNumber
		, index=243};
...
__published:
	...
	__property AnsiString CallbackTelephoneNumber = {read=FCallbackTelephoneNumber, write=FCallbackTelephoneNumber
		, index=81};
	...
	__property AnsiString OtherAddressCountry = {read=FOtherAddressCountry, write=FOtherAddressCountry, 
		index=207};
	__property AnsiString OtherAddressPostalCode = {read=FOtherAddressPostalCode, write=FOtherAddressPostalCode
		, index=209};
	__property AnsiString OtherAddressPostOfficeBox = {read=FOtherAddressPostOfficeBox, write=FOtherAddressPostOfficeBox
		, index=211};
	...
	__property AnsiString OtherTelephoneNumber = {read=FOtherTelephoneNumber, write=FOtherTelephoneNumber
		, index=219};
