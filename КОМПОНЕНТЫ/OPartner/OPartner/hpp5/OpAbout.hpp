...
// (DO NOT EDIT: machine generated header) 'OpAbout.pas' rev: 5.00
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TFrmAbout(Classes::TComponent* AOwner) : Forms::TForm(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TFrmAbout(Classes::TComponent* AOwner, int Dummy
