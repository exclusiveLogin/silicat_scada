...
// (DO NOT EDIT: machine generated header) 'OpWord.pas' rev: 5.00
...
#include <OpWrd2k.hpp>	// Pascal unit
...
public:
	virtual HRESULT __safecall Get_Application_(Opwrd2k::_di__Application &Get_Application__result) = 0 
		;
	...
	virtual HRESULT __safecall Get_ActivePane(Opwrd2k::_di_Pane &Get_ActivePane_result) = 0 ;
	virtual HRESULT __safecall Get_Document(Opwrd2k::_di__Document &Get_Document_result) = 0 ;
	virtual HRESULT __safecall Get_Panes(Opwrd2k::_di_Panes &Get_Panes_result) = 0 ;
	virtual HRESULT __safecall Get_Selection(Opwrd2k::_di_Selection &Get_Selection_result) = 0 ;
	...
	virtual HRESULT __safecall Get_View(Opwrd2k::_di_View &Get_View_result) = 0 ;
	virtual HRESULT __safecall Get_Type_(Activex::TOleEnum &Get_Type__result) = 0 ;
	virtual HRESULT __safecall Get_Next(Opwrd2k::_di_Window_ &Get_Next_result) = 0 ;
	virtual HRESULT __safecall Get_Previous(Opwrd2k::_di_Window_ &Get_Previous_result) = 0 ;
	...
	virtual HRESULT __safecall SmallScroll(OleVariant &Down, OleVariant &Up, OleVariant &ToRight, OleVariant 
		&ToLeft) = 0 ;
	virtual HRESULT __safecall NewWindow(Opwrd2k::_di_Window_ &NewWindow_result) = 0 ;
	...
	/* safecall wrapper */ inline Opwrd2k::_di__Application _scw_Get_Application_() { Opwrd2k::_di__Application r; HRESULT hr = Get_Application_(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property Opwrd2k::_di__Application Application_ = {read=_scw_Get_Application_};
	#pragma option push -w-inl
	...
	#pragma option push -w-inl
	/* safecall wrapper */ inline Opwrd2k::_di_Pane _scw_Get_ActivePane() { Opwrd2k::_di_Pane r; HRESULT hr = Get_ActivePane(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property Opwrd2k::_di_Pane ActivePane = {read=_scw_Get_ActivePane};
	#pragma option push -w-inl
	/* safecall wrapper */ inline Opwrd2k::_di__Document _scw_Get_Document() { Opwrd2k::_di__Document r; HRESULT hr = Get_Document(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property Opwrd2k::_di__Document Document = {read=_scw_Get_Document};
	#pragma option push -w-inl
	/* safecall wrapper */ inline Opwrd2k::_di_Panes _scw_Get_Panes() { Opwrd2k::_di_Panes r; HRESULT hr = Get_Panes(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property Opwrd2k::_di_Panes Panes = {read=_scw_Get_Panes};
	#pragma option push -w-inl
	/* safecall wrapper */ inline Opwrd2k::_di_Selection _scw_Get_Selection() { Opwrd2k::_di_Selection r; HRESULT hr = Get_Selection(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property Opwrd2k::_di_Selection Selection = {read=_scw_Get_Selection};
	#pragma option push -w-inl
	...
	#pragma option push -w-inl
	/* safecall wrapper */ inline Opwrd2k::_di_View _scw_Get_View() { Opwrd2k::_di_View r; HRESULT hr = Get_View(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property Opwrd2k::_di_View View = {read=_scw_Get_View};
	#pragma option push -w-inl
	...
	#pragma option push -w-inl
	/* safecall wrapper */ inline Opwrd2k::_di_Window_ _scw_Get_Next() { Opwrd2k::_di_Window_ r; HRESULT hr = Get_Next(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property Opwrd2k::_di_Window_ Next = {read=_scw_Get_Next};
	#pragma option push -w-inl
	/* safecall wrapper */ inline Opwrd2k::_di_Window_ _scw_Get_Previous() { Opwrd2k::_di_Window_ r; HRESULT hr = Get_Previous(
		r); System::CheckSafecallResult(hr); return r; }
	#pragma option pop
	__property Opwrd2k::_di_Window_ Previous = {read=_scw_Get_Previous};
	#pragma option push -w-inl
...
enum TOpWdViewType { wdvtNormalView, wdvtOutlineView, wdvtPrintView, wdvtPrintPreview, wdvtMasterView, 
	wdvtWebView };
#pragma option pop
...
#pragma option push -b-
enum TOpWdFontAnimation { wdfaNone, wdfaLasVegasLights, wdfaBlinkingBackground, wdfaSparkleText, wdfaMarchingBlackAnts, 
	wdfaMarchingRedAnts, wdfaShimmer };
#pragma option pop
...
private:
	Opwrd2k::_di_MailMerge FIntf;
	Opmodels::TOpUnknownComponent* FModel;
	void __fastcall SetModel(const Opmodels::TOpUnknownComponent* Value);
	
public:
	void __fastcall SetDoc(Opwrd2k::_di__Document Doc);
	__property Opwrd2k::_di_MailMerge AsMailMerge = {read=FIntf};
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpDocumentShapes(Classes::TComponent* RootComponent
		, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(RootComponent
		, Owner, ItemClass) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollectionItem.Create */ inline __fastcall virtual TOpDocumentHyperLink(Classes::TCollection* 
		Collection) : Opshared::TOpNestedCollectionItem(Collection) { }
	#pragma option pop
...
public:
	...
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpDocumentHyperLinks(Classes::TComponent* 
		RootComponent, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(
		RootComponent, Owner, ItemClass) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollectionItem.Create */ inline __fastcall virtual TOpDocumentBookmark(Classes::TCollection* 
		Collection) : Opshared::TOpNestedCollectionItem(Collection) { }
	#pragma option pop
...
public:
	...
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpDocumentBookmarks(Classes::TComponent* 
		RootComponent, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(
		RootComponent, Owner, ItemClass) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollectionItem.Create */ inline __fastcall virtual TOpDocumentTable(Classes::TCollection* 
		Collection) : Opshared::TOpNestedCollectionItem(Collection) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpDocumentTables(Classes::TComponent* RootComponent
		, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(RootComponent
		, Owner, ItemClass) { }
	#pragma option pop
...
private:
	...
	Opwrd2k::_di__Document __fastcall GetAsDocument();
...
public:
	...
	bool __fastcall Replace(const AnsiString FindText, const AnsiString ReplaceText, bool Forward, TOpWdReplaceOption 
		ReplaceOption);
	void __fastcall Save(void);
	void __fastcall SaveAs(const AnsiString FileName);
	void __fastcall SendMailWithOutLook(const AnsiString WordSubject, const AnsiString SendTo, const AnsiString 
		SendCC, const AnsiString SendBC, Opoutlk::TOpOutlook* OutlookComp, bool AsAttachment);
	__property Opwrd2k::_di__Document AsDocument = {read=GetAsDocument};
...
__published:
	...
	__property TOpWdDocumentKind DocumentKind = {read=GetDocumentKind, write=SetDocumentKind, stored=SaveCollection
		, nodefault};
	__property TOpDocumentBookmarks* Bookmarks = {read=FDocumentBookmarks, write=FDocumentBookmarks, stored=
		SaveCollection};
	__property TOpDocumentTables* Tables = {read=FDocumentTables, write=FDocumentTables, stored=SaveCollection
		};
	__property TOpDocumentHyperLinks* HyperLinks = {read=FDocumentHyperLinks, write=FDocumentHyperLinks
		, stored=SaveCollection};
	...
	__property Word AutoHyphenation = {read=GetAutoHyphenation, write=SetAutoHyphenation, stored=SaveCollection
		, nodefault};
	__property Word HyphenateCaps = {read=GetHyphenateCaps, write=SetHyphenateCaps, stored=SaveCollection
		, nodefault};
	__property int HyphenationZone = {read=GetHyphenationZone, write=SetHyphenationZone, stored=SaveCollection
		, nodefault};
	__property int ConsecutiveHyphensLimit = {read=GetConsecutiveHyphensLimit, write=SetConsecutiveHyphensLimit
		, stored=SaveCollection, nodefault};
	__property Word HasRoutingSlip = {read=GetHasRoutingSlip, write=SetHasRoutingSlip, stored=SaveCollection
		, nodefault};
	...
	__property Word EmbedTrueTypeFonts = {read=GetEmbedTrueTypeFonts, write=SetEmbedTrueTypeFonts, stored=
		SaveCollection, nodefault};
	__property Word SaveFormsData = {read=GetSaveFormsData, write=SetSaveFormsData, stored=SaveCollection
		, nodefault};
	__property Word ReadOnlyRecommended = {read=GetReadOnlyRecommended, write=SetReadOnlyRecommended, stored=
		SaveCollection, nodefault};
	__property Word SaveSubsetFonts = {read=GetSaveSubsetFonts, write=SetSaveSubsetFonts, stored=SaveCollection
		, nodefault};
	__property Word UpdateStylesOnOpen = {read=GetUpdateStylesOnOpen, write=SetUpdateStylesOnOpen, stored=
		SaveCollection, nodefault};
	__property Word GrammarChecked = {read=GetGrammarChecked, write=SetGrammarChecked, stored=SaveCollection
		, nodefault};
	__property Word SpellingChecked = {read=GetSpellingChecked, write=SetSpellingChecked, stored=SaveCollection
		, nodefault};
	__property Word ShowGrammaticalErrors = {read=GetShowGrammaticalErrors, write=SetShowGrammaticalErrors
		, stored=SaveCollection, nodefault};
	__property Word ShowSpellingErrors = {read=GetShowSpellingErrors, write=SetShowSpellingErrors, stored=
		SaveCollection, nodefault};
	__property TOpWdSummaryMode SummaryViewMode = {read=GetSummaryViewMode, write=SetSummaryViewMode, stored=
		SaveCollection, nodefault};
	__property int SummaryLength = {read=GetSummaryLength, write=SetSummaryLength, stored=SaveCollection
		, nodefault};
	__property Word PrintPostScriptOverText = {read=GetPrintPostScriptOverText, write=SetPrintPostScriptOverText
		, stored=SaveCollection, nodefault};
	__property Word PrintFormsData = {read=GetPrintFormsData, write=SetPrintFormsData, stored=SaveCollection
		, nodefault};
	...
	__property Word TrackRevisions = {read=GetTrackRevisions, write=SetTrackRevisions, stored=SaveCollection
		, nodefault};
	__property Word PrintRevisions = {read=GetPrintRevisions, write=SetPrintRevisions, stored=SaveCollection
		, nodefault};
	__property Word ShowRevisions = {read=GetShowRevisions, write=SetShowRevisions, stored=SaveCollection
		, nodefault};
	__property TOpWdRangeLimit RangeLimit = {read=FdocRangeLimit, write=SetRangeLimit, stored=SaveCollection
		, nodefault};
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpWordDocuments(Classes::TComponent* RootComponent
		, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(RootComponent
		, Owner, ItemClass) { }
	#pragma option pop
...
typedef void __fastcall (__closure *TOnDocumentOpen)(System::TObject* Sender, Opwrd2k::_di__Document 
	Doc);

typedef void __fastcall (__closure *TOnDocumentBeforeClose)(System::TObject* Sender, Opwrd2k::_di__Document 
	Doc, Word &Cancel);

typedef void __fastcall (__closure *TOnDocumentBeforePrint)(System::TObject* Sender, Opwrd2k::_di__Document 
	Doc, Word &Cancel);

typedef void __fastcall (__closure *TOnDocumentBeforeSave)(System::TObject* Sender, Opwrd2k::_di__Document 
	Doc, Word &SaveAsUI, Word &Cancel);

typedef void __fastcall (__closure *TOnNewDocument)(System::TObject* Sender, Opwrd2k::_di__Document 
	Doc);

typedef void __fastcall (__closure *TOnWindowActivate)(System::TObject* Sender, Opwrd2k::_di__Document 
	Doc, const _di_WordWindow Wn);

typedef void __fastcall (__closure *TOnWindowDeactivate)(System::TObject* Sender, Opwrd2k::_di__Document 
	Doc, const _di_WordWindow Wn);

typedef void __fastcall (__closure *TOnWindowSelectionChange)(System::TObject* Sender, Opwrd2k::_di_Selection 
	Sel);

typedef void __fastcall (__closure *TOnWindowBeforeRightClick)(System::TObject* Sender, Opwrd2k::_di_Selection 
	Sel, Word &Cancel);

typedef void __fastcall (__closure *TOnWindowBeforeDoubleClick)(System::TObject* Sender, Opwrd2k::_di_Selection 
	Sel, Word &Cancel);

class DELPHICLASS TOpWord;
class PASCALIMPLEMENTATION TOpWord : public Opwrd2k::TOpWordBase 
{
	typedef Opwrd2k::TOpWordBase inherited;
	
protected:
	Opwrd2k::_di__Application FServer;
	bool FVisible;
	AnsiString FCaption;
	...
	Opwrd2k::_di__Application __fastcall GetWordInstance();
	...
	void __fastcall DoDocumentOpen(const Opwrd2k::_di__Document Doc);
	void __fastcall DoDocumentBeforeClose(const Opwrd2k::_di__Document Doc, Word &Cancel);
	void __fastcall DoDocumentBeforePrint(const Opwrd2k::_di__Document Doc, Word &Cancel);
	void __fastcall DoDocumentBeforeSave(const Opwrd2k::_di__Document Doc, Word &SaveAsUI, Word &Cancel
		);
	void __fastcall DoNewDocument(const Opwrd2k::_di__Document Doc);
	void __fastcall DoWindowActivate(const Opwrd2k::_di__Document Doc, const _di_WordWindow Wn);
	void __fastcall DoWindowDeactivate(const Opwrd2k::_di__Document Doc, const _di_WordWindow Wn);
	void __fastcall DoWindowSelectionChange(const Opwrd2k::_di_Selection Sel);
	void __fastcall DoWindowBeforeRightClick(const Opwrd2k::_di_Selection Sel, Word &Cancel);
	void __fastcall DoWindowBeforeDoubleClick(const Opwrd2k::_di_Selection Sel, Word &Cancel);
...
public:
	...
	__property Opwrd2k::_di__Application Server = {read=GetWordInstance};
...
__published:
	...
	__property TOpWdEnableCancelKey EnableCancelKey = {read=GetEnableCancelKey, write=SetEnableCancelKey
		, nodefault};
	...
	__property TOnWindowSelectionChange OnWindowSelectionChange = {read=FOnWindowSelectionChange, write=
		FOnWindowSelectionChange};
	__property TOnWindowBeforeRightClick BeforeWindowRightClick = {read=FOnWindowBeforeRightClick, write=
		FOnWindowBeforeRightClick};
	__property TOnWindowBeforeDoubleClick BeforeWindowDoubleClick = {read=FOnWindowBeforeDoubleClick, write=
		FOnWindowBeforeDoubleClick};
};


//-- var, const, procedure ---------------------------------------------------
extern PACKAGE int __stdcall (*SQLConfigDataSource)(HWND hwndParent, int fRequest, char * lpszDriver
	, char * lpszAttributes);
