...
// (DO NOT EDIT: machine generated header) 'OpExcel.pas' rev: 5.00
...
#include <OpXL2K.hpp>	// Pascal unit
...
public:
	...
	/* Exception.Create */ inline __fastcall ERangeException(const AnsiString Msg) : Sysutils::Exception(
		Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall ERangeException(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall ERangeException(int Ident)/* overload */ : Sysutils::Exception(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall ERangeException(int Ident, const System::TVarRec * Args
		, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall ERangeException(const AnsiString Msg, int AHelpContext
		) : Sysutils::Exception(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall ERangeException(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall ERangeException(int Ident, int AHelpContext)/* overload */
		 : Sysutils::Exception(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall ERangeException(System::PResStringRec ResStringRec
...
#pragma option push -b-
enum TOpXlCellHorizAlign { xlchaGeneral, xlchaLeft, xlchaCenter, xlchaRight, xlchaFill, xlchaJustify, 
	xlchaCenterAcrossSelection };
#pragma option pop
...
#pragma option push -b-
enum TOpXlInteriorPatterns { xlipPatternAutomatic, xlipPatternChecker, xlipPatternCrissCross, xlipPatternDown, 
	xlipPatternGray16, xlipPatternGray25, xlipPatternGray50, xlipPatternGray75, xlipPatternGray8, xlipPatternGrid, 
	xlipPatternHorizontal, xlipPatternLightDown, xlipPatternLightHorizontal, xlipPatternLightUp, xlipPatternLightVertical, 
	xlipPatternNone, xlipPatternSemiGray75, xlipPatternSolid, xlipPatternUp, xlipPatternVertical };
#pragma option pop

#pragma option push -b-
enum TOpXlBorderLineStyles { xlblsContinuous, xlblsDash, xlblsDashDot, xlblsDashDotDot, xlblsDot, xlblsDouble, 
	xlblsLineStyleNone, xlblsSlantDashDot };
#pragma option pop
...
#pragma option push -b-
enum TOpXlChartType { xlctArea, xlctBar, xlctLine, xlctPie, xlctRadar, xlctXYScatter, xlct3DArea, xlct3DBar, 
	xlct3DLine, xlct3DPie, xlct3DColumn, xlctDoughnut, xlctUnknown };
#pragma option pop

typedef void __fastcall (__closure *TOnNewWorkBook)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	WorkBook);

typedef void __fastcall (__closure *TOnSheetSelectionChange)(System::TObject* Sender, const _di_IDispatch 
	Sh, const _di_ExcelRange Target);

typedef void __fastcall (__closure *TBeforeSheetDoubleClick)(System::TObject* Sender, const _di_IDispatch 
	Sh, const _di_ExcelRange Target, Word &Cancel);

typedef void __fastcall (__closure *TBeforeSheetRightClick)(System::TObject* Sender, const _di_IDispatch 
	Sh, const _di_ExcelRange Target, Word &Cancel);

typedef void __fastcall (__closure *TOnSheetActivate)(System::TObject* Sender, const _di_IDispatch Sh
	);

typedef void __fastcall (__closure *TOnSheetDeactivate)(System::TObject* Sender, const _di_IDispatch 
	Sh);

typedef void __fastcall (__closure *TOnSheetCalculate)(System::TObject* Sender, const _di_IDispatch 
	Sh);

typedef void __fastcall (__closure *TOnSheetChange)(System::TObject* Sender, const _di_IDispatch Sh, 
	const _di_ExcelRange Target);

typedef void __fastcall (__closure *TOnWorkbookOpen)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb);

typedef void __fastcall (__closure *TOnWorkbookActivate)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb);

typedef void __fastcall (__closure *TOnWorkbookDeactivate)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb);

typedef void __fastcall (__closure *TBeforeWorkbookClose)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb, Word &Cancel);

typedef void __fastcall (__closure *TBeforeWorkbookSave)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb, Word SaveAsUI, Word &Cancel);

typedef void __fastcall (__closure *TBeforeWorkbookPrint)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb, Word &Cancel);

typedef void __fastcall (__closure *TOnWorkbookNewSheet)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb, const _di_IDispatch Sh);

typedef void __fastcall (__closure *TOnWorkbookAddinInstall)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb);

typedef void __fastcall (__closure *TOnWorkbookAddinUninstall)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb);

typedef void __fastcall (__closure *TOnWindowResize)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb, const _di_ExcelWindow Wn);

typedef void __fastcall (__closure *TOnWindowActivate)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb, const _di_ExcelWindow Wn);

typedef void __fastcall (__closure *TOnWindowDeactivate)(System::TObject* Sender, const Opxl2k::_di__Workbook 
	Wb, const _di_ExcelWindow Wn);
...
public:
	...
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpExcelWorksheets(Classes::TComponent* 
...
private:
	...
	Opxl2k::_di__Workbook __fastcall GetAsWorkbook();
...
public:
	...
	__property Opxl2k::_di__Workbook AsWorkbook = {read=GetAsWorkbook};
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpExcelWorkbooks(Classes::TComponent* RootComponent
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpExcelRanges(Classes::TComponent* RootComponent
		, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(RootComponent
		, Owner, ItemClass) { }
	#pragma option pop
...
public:
	...
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpExcelHyperlinks(Classes::TComponent* 
		RootComponent, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(
		RootComponent, Owner, ItemClass) { }
	#pragma option pop
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollection.Create */ inline __fastcall virtual TOpExcelCharts(Classes::TComponent* RootComponent
		, Classes::TPersistent* Owner, TMetaClass* ItemClass) : Opshared::TOpNestedCollection(RootComponent
		, Owner, ItemClass) { }
	#pragma option pop
...
private:
	...
	Opxl2k::_di__Worksheet __fastcall GetAsWorksheet();
...
public:
	...
	void __fastcall Print(void);
	virtual void __fastcall Connect(void);
	__property Opxl2k::_di__Worksheet AsWorksheet = {read=GetAsWorksheet};
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollectionItem.Create */ inline __fastcall virtual TOpExcelWorksheet(Classes::TCollection* 
...
private:
	...
	Opxl2k::_di_Range __fastcall GetAsRange();
...
public:
	...
	__property Opxl2k::_di_Range AsRange = {read=GetAsRange};
...
__published:
	...
	__property TOpXlRangeFontAttributes FontAttributes = {read=FFontAttributes, write=SetFontAttributes
		, nodefault};
	...
	__property TOpXlCellHorizAlign HorizontalAlignment = {read=FHorizontalAlignment, write=SetHorizontalAlignment
		, nodefault};
	__property TOpXlCellVertAlign VerticalAlignment = {read=FVerticalAlignment, write=SetVerticalAlignment
		, nodefault};
	...
	__property TOpXlBorderWeights BorderLineWeight = {read=FBorderLineThickness, write=SetBorderLineThickness
		, nodefault};
...
private:
	...
	void __fastcall SetAddress(const AnsiString Value);
	Opxl2k::_di_Hyperlink __fastcall GetAsHyperlink();
	AnsiString __fastcall GetAddress();
	AnsiString __fastcall GetAnchorCell();
...
public:
	...
	__property Opxl2k::_di_Hyperlink AsHyperlink = {read=GetAsHyperlink};
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollectionItem.Create */ inline __fastcall virtual TOpExcelHyperlink(Classes::TCollection* 
		Collection) : Opshared::TOpNestedCollectionItem(Collection) { }
	#pragma option pop
...
private:
	...
	Opxl2k::_di__Chart __fastcall GetAsChart();
	Opxl2k::_di_ChartObject __fastcall GetAsChartObject();
...
public:
	...
	virtual void __fastcall ExecuteVerb(int index);
	void __fastcall SetAddressFromSelection(void);
	__property Opxl2k::_di__Chart AsChart = {read=GetAsChart};
	__property Opxl2k::_di_ChartObject AsChartObject = {read=GetAsChartObject};
...
public:
	#pragma option push -w-inl
	/* TOpNestedCollectionItem.Create */ inline __fastcall virtual TOpExcelChart(Classes::TCollection* 
		Collection) : Opshared::TOpNestedCollectionItem(Collection) { }
	#pragma option pop
...
class PASCALIMPLEMENTATION TOpExcel : public Opxl2k::TOpExcelBase 
{
	typedef Opxl2k::TOpExcelBase inherited;
	
private:
	Opxl2k::_di__Application FServer;
	bool FInteractive;
...
protected:
	...
	DYNAMIC void __fastcall DoNewWorkbook(const Opxl2k::_di__Workbook WorkBook);
	DYNAMIC void __fastcall DoSheetSelectionChange(const _di_IDispatch Sh, const Opxl2k::_di_Range Target
		);
	DYNAMIC void __fastcall DoBeforeSheetDoubleClick(const _di_IDispatch Sh, const Opxl2k::_di_Range Target
		, Word &Cancel);
	DYNAMIC void __fastcall DoBeforeSheetRightClick(const _di_IDispatch Sh, const Opxl2k::_di_Range Target
		, Word &Cancel);
	...
	DYNAMIC void __fastcall DoSheetChange(const _di_IDispatch Sh, const Opxl2k::_di_Range Target);
	DYNAMIC void __fastcall DoWorkbookOpen(const Opxl2k::_di__Workbook Wb);
	DYNAMIC void __fastcall DoWorkbookActivate(const Opxl2k::_di__Workbook Wb);
	DYNAMIC void __fastcall DoWorkbookDeactivate(const Opxl2k::_di__Workbook Wb);
	DYNAMIC void __fastcall DoBeforeWorkbookClose(const Opxl2k::_di__Workbook Wb, Word &Cancel);
	DYNAMIC void __fastcall DoBeforeWorkbookSave(const Opxl2k::_di__Workbook Wb, Word SaveAsUI, Word &Cancel
		);
	DYNAMIC void __fastcall DoBeforeWorkbookPrint(const Opxl2k::_di__Workbook Wb, Word &Cancel);
	DYNAMIC void __fastcall DoWorkbookNewSheet(const Opxl2k::_di__Workbook Wb, const _di_IDispatch Sh);
		
	DYNAMIC void __fastcall DoWorkbookAddinInstall(const Opxl2k::_di__Workbook Wb);
	DYNAMIC void __fastcall DoWorkbookAddinUninstall(const Opxl2k::_di__Workbook Wb);
	DYNAMIC void __fastcall DoWindowResize(const Opxl2k::_di__Workbook Wb, const _di_ExcelWindow Wn);
	DYNAMIC void __fastcall DoWindowActivate(const Opxl2k::_di__Workbook Wb, const _di_ExcelWindow Wn);
		
	DYNAMIC void __fastcall DoWindowDeactivate(const Opxl2k::_di__Workbook Wb, const _di_ExcelWindow Wn
		);
...
public:
	...
	__property Opxl2k::_di__Application Server = {read=FServer};
...
__published:
	...
	__property TOnWorkbookAddinUninstall OnWorkbookAddinUninstall = {read=FOnWorkbookAddinUninstall, write=
