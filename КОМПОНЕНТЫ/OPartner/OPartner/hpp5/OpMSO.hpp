...
// (DO NOT EDIT: machine generated header) 'OpMSO.pas' rev: 5.00
...
private:
	...
	Opofc2k::_di_Balloon FCOMBalloon;
	AnsiString FText;
...
public:
	...
	void __fastcall SetAppAssistant(Opofc2k::_di_Assistant COMAssistant);
...
__published:
	...
	__property Word KeyboardShortcutTips = {read=GetKeyboardShortcutTips, write=SetKeyboardShortcutTips
		, nodefault};
	...
	__property Word SearchWhenProgramming = {read=GetSearchWhenProgramming, write=SetSearchWhenProgramming
		, nodefault};
