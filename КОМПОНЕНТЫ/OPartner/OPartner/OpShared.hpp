...
// (DO NOT EDIT: machine generated header) 'OpShared.pas' rev: 5.00
...
{
//-- type declarations -------------------------------------------------------
typedef HRESULT __stdcall (*TOpCoCreateInstanceExProc)(const GUID &clsid, _di_IUnknown unkOuter, int 
	dwClsCtx, Activex::PCoServerInfo ServerInfo, int dwCount, Activex::PMultiQIArray rgmqResults);
...
#pragma option push -b-
enum TOpOfficeVersion { ovUnknown, ov97, ov98, ov2000 };
#pragma option pop

typedef void __fastcall (__closure *TOpGetInstanceEvent)(System::TObject* Sender, _di_IDispatch &Instance
	, const GUID &CLSID, const GUID &IID);
...
public:
	...
	/* Exception.Create */ inline __fastcall EOpOfficeError(const AnsiString Msg) : Sysutils::Exception(
		Msg) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmt */ inline __fastcall EOpOfficeError(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size) : Sysutils::Exception(Msg, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateRes */ inline __fastcall EOpOfficeError(int Ident)/* overload */ : Sysutils::Exception(
		Ident) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmt */ inline __fastcall EOpOfficeError(int Ident, const System::TVarRec * Args
		, const int Args_Size)/* overload */ : Sysutils::Exception(Ident, Args, Args_Size) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateHelp */ inline __fastcall EOpOfficeError(const AnsiString Msg, int AHelpContext)
		 : Sysutils::Exception(Msg, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateFmtHelp */ inline __fastcall EOpOfficeError(const AnsiString Msg, const System::TVarRec 
		* Args, const int Args_Size, int AHelpContext) : Sysutils::Exception(Msg, Args, Args_Size, AHelpContext
		) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResHelp */ inline __fastcall EOpOfficeError(int Ident, int AHelpContext)/* overload */
		 : Sysutils::Exception(Ident, AHelpContext) { }
	#pragma option pop
	#pragma option push -w-inl
	/* Exception.CreateResFmtHelp */ inline __fastcall EOpOfficeError(System::PResStringRec ResStringRec
...
public:
	#pragma option push -w-inl
	/* TComponent.Create */ inline __fastcall virtual TOpBaseComponent(Classes::TComponent* AOwner) : Classes::TComponent(
		AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
...
protected:
	...
	virtual void __fastcall CreateEvents(_di_IUnknown Server, const GUID &EventsIID);
...
public:
	__fastcall virtual TOpNestedCollection(Classes::TComponent* RootComponent, Classes::TPersistent* Owner
