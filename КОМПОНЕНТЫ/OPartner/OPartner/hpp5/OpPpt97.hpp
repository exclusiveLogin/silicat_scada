...
// (DO NOT EDIT: machine generated header) 'OpPpt97.pas' rev: 5.00
...
public:
	...
	virtual HRESULT __safecall Run(const WideString MacroName, Activex::PSafeArray &safeArrayOfParams, OleVariant &Run_result
		) = 0 ;
	virtual HRESULT __safecall FileDialog(Activex::TOleEnum Type_, _di_FileDialog &FileDialog_result) = 0 
		;
...
__interface INTERFACE_UUID("{914934BF-5A91-11CF-8700-00AA0060263B}") MouseDownHandler  : public IUnknown 
	
{
	
public:
	virtual HRESULT __stdcall OnMouseDown(const _di_IUnknown activeWin) = 0 ;
};
...
static const Shortint ppSaveAsWizard = 0x9;
