...
// (DO NOT EDIT: machine generated header) 'OpModels.pas' rev: 5.00
...
typedef void __fastcall (__closure *TOpModelGetDataEvent)(System::TObject* Sender, int Index, int Row
	, TOpRetrievalMode Mode, int &Size, Variant &Data);

__interface IOpModel;
typedef System::DelphiInterface<IOpModel> _di_IOpModel;
__interface INTERFACE_UUID("{AD426B00-2A14-11D3-9703-0000861F6726}") IOpModel  : public IUnknown 
{
...
public:
	...
	/* TComponent.Create */ inline __fastcall virtual TOpUnknownComponent(Classes::TComponent* AOwner) : 
		Opshared::TOpBaseComponent(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
