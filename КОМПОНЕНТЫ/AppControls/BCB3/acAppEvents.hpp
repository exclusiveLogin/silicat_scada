...
// (DO NOT EDIT: machine generated header) 'acAppEvents.pas' rev: 3.00
...
typedef void __fastcall (__closure *TacAppKeyEvent)(System::TObject* Sender, Word &Key, Classes::TShiftState 
	Shift, System::AnsiString KeyName, bool RepeatedKeypress);

typedef void __fastcall (__closure *TacAppMouseMoveEvent)(System::TObject* Sender, Classes::TShiftState 
	ShiftState, const tagPOINT &ScreenPoint, HWND WindowHandle, int HitTestCode);

typedef void __fastcall (__closure *TacAppMouseEvent)(System::TObject* Sender, Controls::TMouseButton 
	Button, Classes::TShiftState Shift, const tagPOINT &ScreenPoint, HWND WindowHandle, int HitTestCode
	);
...
private:
	...
	bool FFixedMinimizeRestoreAnimation;
...
__published:
	...
	__property bool FixedMinimizeRestoreAnimation = {read=FFixedMinimizeRestoreAnimation, write=FFixedMinimizeRestoreAnimation
		, default=1};
...
public:
	/* TacFormHookComponent.KreateHook */ __fastcall TacAppEvents(Classes::TComponent* aOwner, Controls::TWinControl* 
