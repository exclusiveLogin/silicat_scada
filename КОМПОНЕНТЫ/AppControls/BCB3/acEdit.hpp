...
// (DO NOT EDIT: machine generated header) 'acEdit.pas' rev: 3.00
...
public:
	...
	__property System::AnsiString ValidChars = {read=FValidChars, write=FValidChars};
...
public:
	/* TWinControl.CreateParented */ __fastcall TacCustomEdit(HWND ParentWindow) : Stdctrls::TEdit(ParentWindow
		) { }
...
public:
	/* TPersistent.Destroy */ __fastcall virtual ~TacEditButton(void) { }
	
};

class DELPHICLASS TacEdit;
class PASCALIMPLEMENTATION TacEdit : public Acedit::TacCustomEdit 
{
	typedef Acedit::TacCustomEdit inherited;
...
public:
	/* TacCustomEdit.Create */ __fastcall virtual TacEdit(Classes::TComponent* aOwner) : Acedit::TacCustomEdit(
		aOwner) { }
	/* TacCustomEdit.Destroy */ __fastcall virtual ~TacEdit(void) { }
	
public:
	/* TWinControl.CreateParented */ __fastcall TacEdit(HWND ParentWindow) : Acedit::TacCustomEdit(ParentWindow
		) { }
...
class PASCALIMPLEMENTATION TacNumberEdit : public Acedit::TacCustomEdit 
{
	typedef Acedit::TacCustomEdit inherited;
...
public:
	/* TacCustomEdit.Destroy */ __fastcall virtual ~TacNumberEdit(void) { }
	
public:
	/* TWinControl.CreateParented */ __fastcall TacNumberEdit(HWND ParentWindow) : Acedit::TacCustomEdit(
		ParentWindow) { }
	
};

class DELPHICLASS TacIPMaskEdit;
class PASCALIMPLEMENTATION TacIPMaskEdit : public Acedit::TacNumberEdit 
{
	typedef Acedit::TacNumberEdit inherited;
...
public:
	/* TacCustomEdit.Destroy */ __fastcall virtual ~TacIPMaskEdit(void) { }
	
public:
	/* TWinControl.CreateParented */ __fastcall TacIPMaskEdit(HWND ParentWindow) : Acedit::TacNumberEdit(
		ParentWindow) { }
...
__published:
	...
	__property OnExit ;
public:
	/* TWinControl.CreateParented */ __fastcall TacIPEdit(HWND ParentWindow) : Controls::TCustomControl(
		ParentWindow) { }
