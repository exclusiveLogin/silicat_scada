...
// (DO NOT EDIT: machine generated header) 'OpOutlk.pas' rev: 5.00
...
#include <OpOlk2k.hpp>	// Pascal unit
...
#pragma option push -b-
enum TOpOlDisplayType { oldtUser, oldtDistList, oldtForum, oldtAgent, oldtOrganization, oldtPrivateDistList, 
	oldtRemoteUser };
#pragma option pop

#pragma option push -b-
enum TOpOlTrackingStatus { oltsNone, oltsDelivered, oltsNotDelivered, oltsNotRead, oltsRecallFailure, 
...
#pragma option push -b-
enum TOpOlResponseStatus { olrespstNone, olrespstOrganized, olrespstTentative, olrespstAccepted, olrespstDeclined, 
	olrespstNotResponded };
#pragma option pop
...
#pragma option push -b-
enum TOpOlTaskStatus { olTskStatNotStarted, olTskStatInProgress, olTskStatComplete, olTskStatWaiting, 
	olTskStatDeferred };
#pragma option pop

#pragma option push -b-
enum TOpOlSaveAsType { olsatTXT, olsatRTF, olsatTemplate, olsatMSG, olsatDoc, olsatHTML, olsatVCard, 
	olsatVCal };
#pragma option pop
...
typedef void __fastcall (__closure *TOptionsPagesAddEvent)(Opolk2k::_di_PropertyPages Pages);
...
public:
	__fastcall TOpAttachmentList(TOpOutlookItem* AOwner, Opolk2k::_di_Attachments Intf);
	...
	__property Opolk2k::_di_Attachments AttachmentsIntf = {read=FIntf};
public:
	#pragma option push -w-inl
...
public:
	__fastcall TOpRecipientList(TOpOutlookItem* AOwner, Opolk2k::_di_Recipients Intf);
	...
	__property Opolk2k::_di_Recipients RecipientsIntf = {read=FIntf};
public:
	#pragma option push -w-inl
...
private:
	Opolk2k::_di__AppointmentItem FAppointmentItem;
	...
	Opolk2k::_di_FormDescription __fastcall GetFormDescription();
	TOpOlImportance __fastcall GetImportance(void);
	Opolk2k::_di__Inspector __fastcall GetInspector();
...
public:
	__fastcall TOpAppointmentItem(Opolk2k::_di__AppointmentItem ApptItem);
	...
	Opolk2k::_di_RecurrencePattern __fastcall GetRecurrencePattern();
	Opolk2k::_di__MeetingItem __fastcall Respond(TOpOlMeetingResponse Response, bool NoUI, bool AdditionalTextDialog
		);
	void __fastcall Send(void);
	__property Opolk2k::_di__AppointmentItem AppointmentItem = {read=FAppointmentItem};
	...
	__property Opolk2k::_di_FormDescription FormDescription = {read=GetFormDescription};
	__property TOpOlImportance Importance = {read=GetImportance, write=SetImportance, nodefault};
	__property Opolk2k::_di__Inspector ItemInspector = {read=GetInspector};
	...
	__property int ReminderMinutesBeforeStart = {read=GetReminderMinutesBeforeStart, write=SetReminderMinutesBeforeStart
		, nodefault};
	__property bool ReminderOverrideDefault = {read=GetReminderOverrideDefault, write=SetReminderOverrideDefault
		, nodefault};
...
private:
	Opolk2k::_di__ContactItem FContactItem;
	...
	Opolk2k::_di_UserProperties __fastcall GetUserProperties();
...
public:
	__fastcall TOpContactItem(Opolk2k::_di__ContactItem AContactItem);
	__property Opolk2k::_di__ContactItem ContactItem = {read=FContactItem};
	void __fastcall Close(TOpOlInspectorClose SaveMode);
	_di_IDispatch __fastcall Copy();
	void __fastcall Delete(void);
	void __fastcall Display(bool Modal);
	_di_IDispatch __fastcall Move(const Opolk2k::_di_MAPIFolder DestFldr);
	void __fastcall PrintOut(void);
	void __fastcall Save(void);
	void __fastcall SaveAs(const AnsiString Path, TOpOlSaveAsType SaveAsType);
	...
	__property bool Saved = {read=GetSaved, nodefault};
	__property int Size = {read=GetSize, nodefault};
	__property Opolk2k::_di_UserProperties UserProperties = {read=GetUserProperties};
	...
	__property TOpOlMailingAddress SelectedMailingAddress = {read=GetSelectedMailingAddress, write=SetSelectedMailingAddress
		, nodefault};
...
private:
	Opolk2k::_di__JournalItem FJournalItem;
	TOpAttachmentList* FAttachments;
	AnsiString __fastcall GetBillingInformation();
	AnsiString __fastcall GetBody();
	AnsiString __fastcall GetCategories();
...
public:
	__fastcall TOpJournalItem(Opolk2k::_di__JournalItem AJournalItem);
	void __fastcall Close(TOpOlInspectorClose SaveMode);
	...
	__property TOpOlImportance Importance = {read=GetImportance, write=SetImportance, nodefault};
	__property Opolk2k::_di__Inspector ItemInspector = {read=GetInspector};
	__property Opolk2k::_di__JournalItem JournalItem = {read=FJournalItem};
	__property System::TDateTime LastModificationTime = {read=GetLastModificationTime};
	__property AnsiString MessageClass = {read=GetMessageClass, write=SetMessageClass};
	__property AnsiString Mileage = {read=GetMileage, write=SetMileage};
	__property bool NoAging = {read=GetNoAging, write=SetNoAging, nodefault};
...
public:
	#pragma option push -w-inl
	/* TObject.Destroy */ inline __fastcall virtual ~TOpJournalItem(void) { }
	#pragma option pop
...
private:
	Opolk2k::_di__NoteItem FNoteItem;
	AnsiString __fastcall GetBody();
	AnsiString __fastcall GetCategories();
...
public:
	__fastcall TOpNoteItem(Opolk2k::_di__NoteItem ANoteItem);
	void __fastcall Close(TOpOlInspectorClose SaveMode);
	...
	__property AnsiString MessageClass = {read=GetMessageClass, write=SetMessageClass};
	__property Opolk2k::_di__NoteItem NoteItem = {read=FNoteItem};
	__property bool Saved = {read=GetSaved, nodefault};
	__property int Size = {read=GetSize, nodefault};
...
private:
	TOpAttachmentList* FAttachments;
	Opolk2k::_di__PostItem FPostItem;
	AnsiString __fastcall GetBillingInformation();
	AnsiString __fastcall GetBody();
	AnsiString __fastcall GetCategories();
	AnsiString __fastcall GetCompanies();
...
public:
	__fastcall TOpPostItem(Opolk2k::_di__PostItem APostItem);
	...
	__property int OutlookInternalVersion = {read=GetOutlookInternalVersion, nodefault};
	__property AnsiString OutlookVersion = {read=GetOutlookVersion};
	__property Opolk2k::_di__PostItem PostItem = {read=FPostItem};
	__property bool Saved = {read=GetSaved, nodefault};
	__property TOpOlSensitivity Sensitivity = {read=GetSensitivity, write=SetSensitivity, nodefault};
	__property int Size = {read=GetSize, nodefault};
	__property AnsiString Subject = {read=GetSubject, write=SetSubject};
...
private:
	TOpAttachmentList* FAttachments;
	TOpRecipientList* FRecipients;
	Opolk2k::_di__TaskItem FTaskItem;
...
public:
	__fastcall TOpTaskItem(Opolk2k::_di__TaskItem ATaskItem);
	...
	__property Opolk2k::_di__TaskItem TaskItem = {read=FTaskItem};
...
private:
	TOpAttachmentList* FAttachments;
	Opolk2k::_di__MailItem FMailItem;
	TOpRecipientList* FRecipients;
...
public:
	__fastcall TOpMailItem(Opolk2k::_di__MailItem AMailItem);
	...
	__property AnsiString HTMLBody = {read=GetHTMLBody, write=SetHTMLBody};
	__property TOpOlImportance Importance = {read=GetImportance, write=SetImportance, nodefault};
	__property Opolk2k::_di__MailItem MailItem = {read=FMailItem};
...
private:
	...
	Opolk2k::_di_AddressEntry __fastcall GetAddressEntry();
	void __fastcall SetAddressEntry(const Opolk2k::_di_AddressEntry Value);
	
public:
	__fastcall TOpRecipient(TOpRecipientList* AOwner, Opolk2k::_di_Recipient Intf);
	__fastcall virtual ~TOpRecipient(void);
	bool __fastcall Resolve(void);
	__property AnsiString Address = {read=GetAddress};
	__property Opolk2k::_di_AddressEntry AddressEntry = {read=GetAddressEntry, write=SetAddressEntry};
	__property TOpOlDisplayType DisplayType = {read=GetDisplayType, nodefault};
	__property AnsiString EntryID = {read=GetEntryID};
	__property int Index = {read=GetIndex, nodefault};
	__property AnsiString Name = {read=GetName};
	__property Opolk2k::_di_Recipient RecipientIntf = {read=FIntf};
...
private:
	...
	Opolk2k::_di_Attachment FIntf;
	AnsiString __fastcall GetFileName();
	AnsiString __fastcall GetPathName();
	AnsiString __fastcall GetDisplayName();
	
public:
	__fastcall TOpAttachment(TOpAttachmentList* AOwner, Opolk2k::_di_Attachment Intf);
	__fastcall virtual ~TOpAttachment(void);
	__property Opolk2k::_di_Attachment AttachmentIntf = {read=FIntf};
...
class PASCALIMPLEMENTATION TOpOutlook : public Opolk2k::TOpOutlookBase 
{
	typedef Opolk2k::TOpOutlookBase inherited;
	
private:
	Opolk2k::_di__NameSpace FMapiNamespace;
	bool FNewSession;
	Opolk2k::_di__Application FServer;
...
protected:
	...
	DYNAMIC void __fastcall DoOnOptionsPagesAdd(const Opolk2k::_di_PropertyPages Pages);
...
public:
	Opolk2k::_di__Application __fastcall CreateInstance();
	...
	void __fastcall SendMailMessage(const AnsiString ToAddrs, const AnsiString CcAddrs, const AnsiString 
		BccAddrs, const AnsiString MsgSubject, Classes::TStrings* MsgText, Classes::TStrings* MsgAttachments
		);
	__property Opolk2k::_di__NameSpace MapiNamespace = {read=FMapiNamespace};
	__property AnsiString Name = {read=GetName};
	__property Opolk2k::_di__Application Server = {read=FServer};
...
public:
	#pragma option push -w-inl
	/* TOpOfficeComponent.Create */ inline __fastcall virtual TOpOutlook(Classes::TComponent* AOwner) : 
		Opolk2k::TOpOutlookBase(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
