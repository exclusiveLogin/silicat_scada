...
uses Classes, ActiveX, OpShared, OpOlk98, OpOlk2k {$IFDEF VERSION6}, Variants {$ENDIF};
...
{$ENDIF}
  ...
  if CoCreate(OpOlk2k.CLASS_Application_, _Application, Result) = S_OK then
...
begin
  try
    ...
    // Appliation events are only supported in Oulook 2000
