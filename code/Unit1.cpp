...
// int l=1;
 ...
 if (FindWindow("TPACQuery","Модуль опроса")==NULL){
        ...
        statusDebug1_S1->Caption="НЕТ СВЯЗИ С МОДУЛЕМ";
        statusDebug1_S1->Font->Color=clRed;
    }
 else{
        statusDebug1_S1->Caption="СВЯЗЬ С МОДУЛЕМ В НОРМЕ";
...
{
        SendMessage(FindWindow("TPACQuery","Модуль опроса"),WM_CLOSE,0,0);
}
//---------------------------------------------------------------------------
void __fastcall TWinScada::statusPLC(TMessage& Message){
        ...
        switch(statPLC){
                case 0:
                        statusDebug2_S1->Caption="В НОРМЕ";
                        statusDebug2_S1->Font->Color=clGreen;
                        break;
                case 1:
                        statusDebug2_S1->Caption="ETHERNET ПОДКЛЮЧЕН";
                        statusDebug2_S1->Font->Color=clGreen;
                        break;
                case 2:
                        statusDebug2_S1->Caption="ЗАПИСЬ В КОНТРОЛЛЕР";
                        statusDebug2_S1->Font->Color=clGreen;
                        break;
                case 100:
                        statusDebug2_S1->Caption="ПОИСК КОНТРОЛЛЕРА";
                        statusDebug2_S1->Font->Color=clRed;
                        break;
                case 101:
                        statusDebug2_S1->Caption="КОНТРОЛЛЕР ОТКЛЮЧЕН";
                        statusDebug2_S1->Font->Color=clRed;
                        break;
                case 102:
                        statusDebug2_S1->Caption="ОШИБКА СОЕДИНЕНИЯ";
                        statusDebug2_S1->Font->Color=clRed;
                        break;
                case 103:
                        statusDebug2_S1->Caption="НЕИЗВЕСТНАЯ ОШИБКА";
                        statusDebug2_S1->Font->Color=clRed;
                        break;
                default:break;
        }
