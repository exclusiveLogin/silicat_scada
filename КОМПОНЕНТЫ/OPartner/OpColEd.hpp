...
// (DO NOT EDIT: machine generated header) 'OpColEd.pas' rev: 5.00
...
enum OpColEd__1 { esCanUndo, esCanRedo, esCanCut, esCanCopy, esCanPaste, esCanDelete, esCanZOrder, esCanAlignGrid, 
...
__published:
	...
	void __fastcall trvCollectionMouseUp(System::TObject* Sender, Controls::TMouseButton Button, Classes::TShiftState 
		Shift, int X, int Y);
...
private:
	...
	Controls::TWndMethod FOldTreeProc;
	void __fastcall CustomTreeProc(Messages::TMessage &Message);
	void __fastcall FreeNodeData(void);
	void __fastcall ClearTree(void);
	Comctrls::TTreeNode* __fastcall AddTreeCollection(Comctrls::TTreeNode* Node, Classes::TCollection* 
		Collection);
...
public:
	...
	/*         class method */ static void __fastcall CreateEditor(TMetaClass* vmt, Dsgnintf::_di_IFormDesigner 
		ADesigner, Classes::TComponent* Component, Classes::TCollection* Collection);
	/*         class method */ static void __fastcall FreeEditor(TMetaClass* vmt);
	void __fastcall ComponentDeleted(Dsgnintf::_di_IPersistent Component);
...
public:
	...
	/* TCustomForm.Create */ inline __fastcall virtual TfrmCollectionEditor(Classes::TComponent* AOwner
		) : Forms::TForm(AOwner) { }
	#pragma option pop
	#pragma option push -w-inl
	/* TCustomForm.CreateNew */ inline __fastcall virtual TfrmCollectionEditor(Classes::TComponent* AOwner
		, int Dummy) : Forms::TForm(AOwner, Dummy) { }
	#pragma option pop
	
public:
	#pragma option push -w-inl
	/* TWinControl.CreateParented */ inline __fastcall TfrmCollectionEditor(HWND ParentWindow) : Forms::TForm(
		ParentWindow) { }
	#pragma option pop
